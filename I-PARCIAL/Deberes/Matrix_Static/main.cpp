...
int main()
{
    ...
    cout << "\ningrese el numero de columnas de la primera matriz" << endl;
    cin >> auxcolumna1;
    columna1 = atoi(operacion.validarSoloNumeros(auxcolumna1).c_str());
    cout << "\ningrese el numero de filas de la segunda matriz" << endl;
    cin >> auxfila2;
    fila2 = atoi(operacion.validarSoloNumeros(auxfila2).c_str());
    cout << "\ningrese el numero de columnas de la segunda matriz" << endl;
    cin >> auxcolumna2;
